...
|---------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| --- |
| **Comunica oralmente con efectividad a diferentes rangos de audiencia.**  | **Anampa Lavado Luis Angel<br/>TB1**: Transmitió pensamientos y hallazgos de manera directa, informando sobre el progreso y los obstáculos del proyecto.<br/><br>**David Polanco, Alessandro Alonso<br/> TB1**: Comunicó ideas y resultados de manera objetiva a audiencias variadas, compartiendo el progreso y los desafíos del proyecto.<br><br/> **TP**: Implemente al funcionalidad del chat en version de frontend para la comunicacion entre el usuario y el conductor de GoUni. <br/><br/>**Talizo Balbin Joan Jefferson, <br/>TB1**: Entrevistó usuarios y realizó sprints backlog, contribuyendo al desarrollo de la landing page.<br/><br>**Valera Garcés Samuel Ignacio, <br/>TB1**: Informó sobre el progreso y los obstáculos del proyecto a públicos especializados. <br/><br/>**TP**: Implementó la funcionalidad del login en Angular CLI, realizando todo el proceso satisfactoriamente.<br/><br>**Mallma Espiritu, Franky <br/>TB1**: En el desarrollo del tb comunique activamente mis avances y desarrollo del proyecto a mi equipo de trabajo ,contribuyendo a ofrecer un producto de una aplicacion web al publico en general <br/><br/>**TP**: En esta entrega contribui a dar ideas y comunicar errores y correcciones con mi equipo de trabajo contribuyendo asi a presentar una exposicion del proyecto amena y satisfactoria                                                                                                                                                                                                                                                                                                                           | **General**: La comunicación clara y precisa fue crucial para el éxito del proyecto, facilitando la cooperación y comprensión entre los equipos. La capacidad de comunicar de manera objetiva y profesional coordinó esfuerzos y mejoró la ejecución del proyecto. |
| **Comunica por escrito con efectividad a diferentes rangos de audiencia** | **Anampa Lavado, Luis Angel <br/><br/>TB1**: Realizó análisis competitivo y contribuyó al product backlog, diseñando la arquitectura de la información y los mockups de la aplicación.<br/><br>**David Polanco, Alessandro <br/><br/>TB1**: Usó el Lean UX Canvas e intervino en el diseño de la Information Architecture y la estructura de la base de datos. <br/><br/>**TP**:En esta seccion del proyecto estuve constantemente en comunicacion con mi equipo acerca de los avances que iba haciendo a lo largo de los dias y las correcionas que iba haciendo de la entrega anterior en respecot al informe, asi mejorando y entablando una mejor comunicacion con mi equipo. <br/><br>**Mallma Espiritu, Franky Oswald <br/><br/>TB1**: Comparti mis ideas con mi equipo a lo largo del proyecto de la aplicacion web, plasmandolo en mis avances del frontend ,y ademas en el informe del proyecto, promoviendo asi una documentacion integral para ser leida por el publico objetivo <br/><br/>**TP**: en esta parte del proyecto comunique a mi equipo sobre las adiciones y correciones escritas en el informe del proyecto, promoviendo asi una excelente y satisfactoria revision del informe del proyecto <br/><br>**Talizo Balbin, Joan Jefferson <br/><br/>TB1**: Contribuyó en diversas etapas del desarrollo, creando user personas y empathy maps.<br/><br>**Valera Garcés, Samuel Ignacio <br/><br/>TB1**: Ayudó en la documentación y diseño de journey mappings y diagram flows para el proyecto.<br/><br>**TP**: Documentó la implementación del login en Angular CLI, asegurando que los procesos fueran claramente entendidos por todos los miembros del equipo. | **General**: La documentación clara y detallada fue fundamental para el desarrollo del proyecto, asegurando que toda la información fuera comprensible para los diversos públicos. La escritura objetiva y profesional facilitó la colaboración y el éxito en cada fase del desarrollo. |
